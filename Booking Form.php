            ...
            <div class="form-group">
              <div class="row">
                ...
                <select class="form-control" name="room_type"required>
                  <option>EzStays Deluxe Room</option>
                  <option>Clanbridge Luxurious Suite</option>
                  <option>White House Girls Standard Room</option>
                  <option> Blue Heaven Suite Room</option>
                  <option>Anandam Double Deluxe Room</option>
               </select>
              </div>
              </div>
            </div>
